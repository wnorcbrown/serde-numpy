...
fn serde_numpy(_py: Python<'_>, m: &PyModule) -> PyResult<()> {
    ...
    fn parse_bool_array<'py>(py: Python<'py>, json_str: &str, key: &str, index: usize) -> PyResult<NumpyTypes<'py>> {
    ...
    fn parse_int_array<'py>(py: Python<'py>, json_str: &str, key: &str, index: usize) -> PyResult<NumpyTypes<'py>> {
    ...
    fn parse_keys_<'py>(py: Python<'py>, json_str: &str, keys: Vec<&str>, indexes: Vec<Vec<usize>>) -> PyResult<HashMap<std::string::String, Vec<NumpyTypes<'py>>>> {
